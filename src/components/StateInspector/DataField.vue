        ...
        <span class="actions">
          ...
          >
            ...
            >
              ...
              >
                {{ 'DataField.contextMenu.copyValue' }}
              </VueDropdownButton>
            </div>
          </VueDropdown>
        </span>
...
import { formattedValue, valueType } from '@/filters'
...
export default {
  ...
  data () {
    ...
    return {
      editCancleTip: '[[{{keys.esc}}]] Cancel',
      submitTip: '[[{{keys.enter}}]] Submit change',
